...
const Main = styled('main', { shouldForwardProp: (prop) => prop !== 'open' })(
  ({ theme }) => ({
    ...
    backgroundColor: 'rgb(58,58,58)', // Set background color to black
...
const AppBar = styled(MuiAppBar, {
  ...
  backgroundColor: 'rgb(58,58,58)', // Set AppBar background to black
  color: 'white', // Optional: Set text color to white for contrast
  variants: [
    {
      props: ({ open }) => open,
      ...
      <Drawer
        sx={{
          ...
          '& .MuiDrawer-paper': {
            ...
            backgroundColor: 'rgb(58,58,58)', // Set Drawer background color to black
            color: 'white', // Optional: Set text color to white for contrast
          },
        }}
        variant="persistent"
      ...
      >
        <DrawerHeader>
          <IconButton onClick={handleDrawerClose}>
            {theme.direction === 'ltr' ? <ChevronLeftIcon sx={{color: 'pink'}} /> : <ChevronRightIcon />}
          </IconButton>
        </DrawerHeader>
        <Divider/>
        <List>
